...
class QuestionController extends Controller
{
    ...
    {
        $quiz = Quiz::whereId($id)->with('questions')->first() ?? abort('404', 'Quiz tapilmadi');
    ...
    {
        $question = Quiz::find($quiz_id)->questions()->whereId($question_id)->first() ?? abort(404, 'Sual yaxud quiz tapilmadi');
    ...
    public function update(QuestionUpdateRequest $request, $quiz_id, $question_id)
    {
        ...
        return redirect()->route('questions.index', $quiz_id)->withSuccess('Sual guncellendi');
    }
